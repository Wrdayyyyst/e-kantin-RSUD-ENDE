<aside class="w-64 bg-[#0f172a] text-white flex flex-col shadow-xl sticky top-0 h-screen">
        ...
        <nav class="flex-1 mt-6 px-4 space-y-1">
            <a href="index.php" class="flex items-center gap-3 p-3 bg-blue-600 rounded-lg transition text-sm font-medium text-white">
            ...
            <?php if ($role == 'admin' || $role == 'pengelola' || $role == 'pemilik') : ?>
            <a href="stok_barang.php" class="flex items-center gap-3 p-3 hover:bg-slate-800 rounded-lg text-sm text-slate-400 hover:text-white transition">
